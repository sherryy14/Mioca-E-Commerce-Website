          ...
          <div class="sidebar-nav" data-simplebar="true">
              ...
              <ul class="metismenu" id="menu">
                ...
                <li>
                  ...
                  <ul>
                    <li> <a href="add-product.php"><span class="material-symbols-outlined">arrow_right</span>Add Product</a>
                    </li>
                    <li> <a href="products.php"><span class="material-symbols-outlined">arrow_right</span>Products</a>
                    </li>
                    ...
                    <li> <a href="add-category.php"><span class="material-symbols-outlined">arrow_right</span>Add Category</a>
                    </li>
                    <li> <a href="categories.php"><span class="material-symbols-outlined">arrow_right</span>Categories</a>
                    </li>
                  </ul>
                </li>
                <li>
