            ...
            <div class="row">
                ...
                <div class="col-12">
                    ...
                    <div class="tab-slider swiper-container slider-nav-style-1 small-nav">
                        ...
                        while($cRow = mysqli_fetch_array($catResult)){

                      
                        ?>

                            <li class="nav-item swiper-slide"><a class="nav-link active" data-bs-toggle="tab"
                                    href="#tab-jewelry"> <img src="assets/images/icons/<?php echo $cRow['cimage']?>"
                                        alt=""><span><?php echo $cRow['cname']?></span></a>
                            </li>
                            <?php   }?>
                    ...
                    <div class="tab-content mt-60px">
                        ...
                        <div class="tab-pane fade show active" id="tab-jewelry">
                            <div class="row">
                                ...
                                $prodResult = mysqli_query($conn, $products);
                                    ...
                                    <div class="product">
                                        <div class="thumb">
                                            <a href="single-product.html" class="image">
                                                <img src="assets/images/product-image/<?php echo $row['img1']?>" alt="Product" />
                                                <img class="hover-image" src="assets/images/product-image/<?php echo $row['img1']?>"
                                                    alt="Product" />
                                            </a>
                                            <span class="badges">
                                                <span class="new"><?php
                                        ...
                                        <div class="content">
                                            ...
                                            <h5 class="title"><a href="single-product.php?id=<?php echo $row['id']?>"><?php echo $row['title']?>
                                                </a>
                                            </h5>
                                            <span class="price">
                    ...
                    <div class="single-blog">
                        ...
                        <div class="blog-text">
                            ...
                            <h5 class="blog-heading"><a class="blog-heading-link"
                                    href="blog-single-left-sidebar.html">How to Explain Handmade Product to Your Boss</a></h5>
                ...
                <div class="col-lg-4 col-md-6 mb-md-30px mb-lm-30px">
                    <div class="single-blog ">
                        ...
                        <div class="blog-text">
                            ...
                            <h5 class="blog-heading"><a class="blog-heading-link"
                                    href="blog-single-left-sidebar.html">7 Best Blogs to Follow About Handmade Goods
                                </a></h5>
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="single-blog">
                        ...
                        <div class="blog-text">
                            ...
                            <h5 class="blog-heading"><a class="blog-heading-link"
                                    href="blog-single-left-sidebar.html">Us Too. 6 Reasons We Just Can't Stop
                                </a></h5>
