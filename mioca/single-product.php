...
$query = "SELECT * FROM `products` AS p INNER JOIN `category` AS c ON c.cid = p.category WHERE p.id = '{$id}'";
        ...
        <div class="container">
            <div class="row align-items-center justify-content-center">
                <div class="col-12 text-center">
                    <h2 class="breadcrumb-title"><?php echo $row['title']?></h2>
                    ...
                    <div class="swiper-container zoom-top">
                        <div class="swiper-wrapper">
                            <div class="swiper-slide zoom-image-hover">
                                <img class="img-responsive m-auto" src="assets/images/product-image/<?php echo $row['img1']?>"
                                    alt="">
                            </div>
                            <div class="swiper-slide zoom-image-hover">
                                <img class="img-responsive m-auto" src="assets/images/product-image/<?php echo $row['img2']?>"
                                    alt="">
                            </div>
                            <div class="swiper-slide zoom-image-hover">
                                <img class="img-responsive m-auto" src="assets/images/product-image/<?php echo $row['img3']?>"
                                    alt="">
                            </div>
                            <div class="swiper-slide zoom-image-hover">
                                <img class="img-responsive m-auto" src="assets/images/product-image/<?php echo $row['img4']?>"
                                    alt="">
                            </div>
                            <div class="swiper-slide zoom-image-hover">
                                <img class="img-responsive m-auto" src="assets/images/product-image/<?php echo $row['img5']?>"
                                    alt="">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="product-details-content quickview-content ml-25px">
                        ...
                        <div class="pricing-meta">
                            <ul class="d-flex">
                                ...
                                <li class="old-price"><del>$<?php echo $row['price']+(30/100*$row['price'])?></del></li>
                            </ul>
                        </div>
                        ...
                        <p class="mt-30px mb-0"><?php echo $row['description']?></p>
